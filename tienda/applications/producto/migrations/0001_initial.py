# Generated by Django 3.0.5 on 2022-04-19 22:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colour', models.CharField(max_length=120, unique=True, verbose_name='Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.URLField(blank=True, null=True, verbose_name='unboxing')),
                ('stock', models.PositiveIntegerField(default=0, verbose_name='Stock')),
                ('num_sales', models.PositiveIntegerField(default=0, verbose_name='Veces vendido')),
                ('colours', models.ManyToManyField(to='producto.Colours')),
            ],
            options={
